module.exports = function toReadable (num) {
    const lowNums = ['',' one', ' two', ' three', ' four', ' five', ' six', ' seven', ' eight', ' nine',
    ' ten', ' eleven', ' twelve', ' thirteen', ' fourteen', ' fifteen', ' sixteen',
    ' seventeen', ' eighteen', ' nineteen'];
    const hightNums = ['','',' twenty', ' thirty', ' forty', ' fifty', ' sixty', ' seventy', ' eighty',
    ' ninety']; 
    const hundred = ' hundred';
     ...
     if(num === 0){
        ...
        console.log(lowNums[parseInt(num.toString().substring(1))])
